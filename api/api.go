...
func login(w http.ResponseWriter, r *http.Request) {
	...
	login := services.Login(formattedBody.Username, formattedBody.Password)
...
func register(w http.ResponseWriter, r *http.Request) {
	...
	register := services.Register(formattedBody.Username, formattedBody.Email, formattedBody.Password)
...
func getUser(w http.ResponseWriter, r *http.Request) {
	...
	user := services.GetUser(userId, auth)
	apiResponse(user, w)
}
...
func getMyTransactions(w http.ResponseWriter, r *http.Request) {
	...
	transactions := services.GetMyTransactions(userId, auth)
...
func transaction(w http.ResponseWriter, r *http.Request) {
	...
	transaction := services.Transaction(formattedBody.UserId, formattedBody.From, formattedBody.To, formattedBody.Amount, auth)
